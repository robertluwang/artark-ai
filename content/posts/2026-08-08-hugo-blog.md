...
```toml
baseURL = 'https://github.com/robertluwang/tech-blog'
languageCode = 'en-us'
title = 'My Tech Blog'
theme = 'papermod'
    ...
    steps:
      ...
      - name: Setup Hugo
        ...
        with:
          ...
          extended: true
      - name: Build
        run: hugo --minify --baseURL "https://robertluwang.github.io/my-tech-blog/"
...
pages:
  ...
  script:
    ...
    - hugo --minify --baseURL "https://gitlab.com/robertluwang/tech-blog"
  artifacts:
    paths:
      - public
  rules:
...
Stage your source code, switch your branch to `main`, link your remote repository, and push:

```bash
git branch -M main
git add .
git commit -m "Initial Hugo setup with PaperMod and CI/CD workflow"
git remote add origin https://gitlab.com/robertluwang/tech-blog.git
# Or for GitHub: git remote add origin https://github.com/robertluwang/my-tech-blog.git
